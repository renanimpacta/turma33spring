...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		/*Define a package onde estão as classes do tipo @RestController, para que o Swagger mapeie
		todas as classes e seus respectivos endpoints para montar a documentação do projeto.*/
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
				.title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/renanimpacta")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Renan Santana", "https://github.com/renanimpacta", "santana.renan@outlook.com");
	}
